	...
	<div class="margin-top">
		<div class="row">
			<div class="span12">
				...
				<p><a class="btn btn-info" href="member.php"><i class="icon-arrow-left icon-large"></i>&nbsp;Back</a>
				</p>
				<div class="addstudent">
					...
					<form class="form-horizontal" method="POST" action="update_students.php"
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="inputPassword" name="lastname"
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="inputPassword" name="gender"
									value="<?php echo $row['gender']; ?>" placeholder="Gender" required>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="inputPassword">Adddress:</label>
							<div class="controls">
								<input type="text" id="inputPassword" name="address"
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type='tel' pattern="[0-9]{11,11}" class="search" name="contact"
