    ...
    <div class="border-borrow">
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <option></option>
                <?php $result =  mysqli_query($conn,"select * from member")or die(mysqli_error($conn)); 
				while ($row=mysqli_fetch_array($result)){ ?>
                <option value="<?php echo $row['member_id']; ?>"><?php echo $row['firstname']." ".$row['lastname']; ?>
                </option>
                <?php } ?>
                </select>
            </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" class="w8em format-d-m-y highlight-days-67 range-low-today" name="due_date" id="sd"
                    maxlength="10" style="border: 3px double #CCCCCC;" required />
            </div>
        </div>
        <div class="control-group">
            <div class="controls">
