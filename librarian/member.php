        ...
        <div class="row">
            <div class="span12">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                    ...
                    <p><a href="add_member.php" class="btn btn-success"><i class="icon-plus"></i>&nbsp;Add Member</a>
                    </p>
                    ...
                    <tbody>
                        ...
                        <?php  $user_query=mysqli_query($conn,"select * from member")or mysqli_close($conn);
                        ...
                        <tr class="del<?php echo $id ?>">
                            ...
                            <td width="100">
                                <a rel="tooltip" title="Delete" id="<?php echo $id; ?>"
                                    href="#delete_student<?php echo $id; ?>" data-toggle="modal"
                                ...
                                <a rel="tooltip" title="Edit" id="e<?php echo $id; ?>"
                                    href="edit_member.php<?php echo '?id='.$id; ?>" class="btn btn-success"><i
